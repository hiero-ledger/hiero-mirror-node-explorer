...
export enum TransactionType {
    ...
    FREEZE = "FREEZE",
    HINTSKEYPUBLICATION = "HINTSKEYPUBLICATION",
    HINTSPARTIALSIGNATURE =  "HINTSPARTIALSIGNATURE",
    HINTSPREPROCESSINGVOTE = "HINTSPREPROCESSINGVOTE",
    HISTORYPROOFKEYPUBLICATION = "HISTORYPROOFKEYPUBLICATION",
    HISTORYPROOFSIGNATURE = "HISTORYPROOFSIGNATURE",
    HISTORYPROOFVOTE = "HISTORYPROOFVOTE",
    HOOKSTORE = "HOOKSTORE",
    LEDGERIDPUBLICATION = "LEDGERIDPUBLICATION",
    MIGRATIONROOTHASHVOTE = "MIGRATIONROOTHASHVOTE",
    NODECREATE = "NODECREATE",
    NODEDELETE = "NODEDELETE",
    NODESTAKEUPDATE = "NODESTAKEUPDATE",
    NODEUPDATE = "NODEUPDATE",
    REGISTEREDNODECREATE = "REGISTEREDNODECREATE",
    REGISTEREDNODEDELETE = "REGISTEREDNODEDELETE",
    REGISTEREDNODEUPDATE = "REGISTEREDNODEUPDATE",
