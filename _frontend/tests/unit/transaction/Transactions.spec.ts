...
describe("Transactions.vue", () => {
    ...
    test("no props", async () => {
        ...
        expect(select.text()).toBe(
            "TYPES: ALLADD LIVE HASHAPPROVE ALLOWANCEATOMIC BATCHCANCEL AIRDROPCLAIM AIRDROPCONTRACT CALL" +
            "CONTRACT CREATECONTRACT DELETECONTRACT UPDATECREATE ACCOUNTCREATE TOPICCRYPTO TRANSFERDELETE " +
            "ACCOUNTDELETE ALLOWANCEDELETE LIVE HASHDELETE TOPICETHEREUM TRANSACTIONFILE APPENDFILE CREATEFILE DELETE" +
            "FILE UPDATEFREEZEHOOK STORENODE CREATENODE DELETENODE STAKE UPDATENODE UPDATE" +
